...
public class centimetro_metro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        this.setTitle(R.string.PANTALLA6);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_centimetro_metro);
